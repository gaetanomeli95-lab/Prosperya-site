...
export function SectionMethod() {
  return (
    <section className="relative overflow-hidden bg-[#172326] py-20 text-white sm:py-24 lg:py-36">
      ...
      <div className="absolute right-[-9rem] bottom-[-6rem] h-[30rem] w-[30rem] rounded-full bg-sand/[0.08] blur-3xl" />
        ...
        <div className="grid gap-10 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-4">
            <FadeIn>
              ...
              <h2 className="mt-7 max-w-xl text-[clamp(2.8rem,5.4vw,6rem)] font-heading leading-[0.94] tracking-[-.04em] !text-white">
            ...
            <div className="relative">
              ...
              {methodSteps.map((step, i) => (
                <FadeIn key={step.title} delay={i * 0.06}>
                  <article className="group relative grid grid-cols-[38px_1fr] gap-5 border-b border-white/14 py-7 first:pt-0 sm:grid-cols-[46px_1fr] lg:grid-cols-[58px_1fr_auto] lg:items-center lg:gap-7 lg:py-9">
                    ...
                    <span className="hidden text-[9px] font-semibold uppercase tracking-[.18em] !text-white/40 transition-colors group-hover:!text-sand lg:block">Execution layer</span>
                  </article>
                </FadeIn>
              ))}
            </div>
